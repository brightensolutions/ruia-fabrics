...
const OurServices: React.FC = () => {
  ...
  return (
    <div className="lg:max-w-[1440px] m-auto px-[20px] my-14">
      <div className="text-center">
        ...
        <p className="w-[70%] m-auto font-roboto">
          ...
          manufacturer, we've embraced change and innovation. We produce voile,
          chiffon, crepe, and georgette fabrics, catering to both domestic and
          international markets. Sustainability is at our core, collaborating
          with Aditya Birla Group to produce eco-friendly fabrics like LIVA and
          LIVA EcoVera.
        </p>
