...
const Aboutus = () => {
  return (
    <div>
      <div className="lg:max-w-[1440px] px-[20px] m-auto my-[50px] ">
        <div className="flex flex-row my-[100px ] relative">
          ...
          <div className="w-[50%]">
            ...
            <p className="text-white/80 font-abel text-[20px] leading-[1.8]">
              Ruia Fabrics is a family-owned organization established in 1952 by
              the late Shri Shubhkaranji Ruia, who began as a yarn merchant
              trading across India. Over decades, the company evolved, expanding
              into fabric trading and manufacturing. In 1990, Madhusudan Ruia
              founded Ruia Fabrics Private Limited, focusing on quality and
              innovation in fabrics.
            </p>
            <p className="text-white/80 font-abel text-[20px] leading-[1.8] mb-[10px]">
              Today, Ruia Fabrics specializes in sustainable practices, weaving
              eco-friendly viscose fabrics in collaboration with the Aditya
              Birla Group. The company produces over 200,000 meters of LIVA
              eco-vera fabrics monthly, adhering to its commitment to
              sustainability and quality.
            </p>
            <p className="text-white/80 font-abel text-[20px] leading-[1.8] mb-[10px]">
              In 2018, Ruia Fabrics expanded further with Klassiq Silk Mills in
              Surat, importing advanced velvet manufacturing machines to produce
              luxurious micro velvet fabrics. With a monthly capacity of one
              lakh meters, Klassiq Silk Mills has established a robust
              distribution network across India and the Middle East, meeting the
