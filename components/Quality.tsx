...
const Quality = () => {
  return (
    <div className="bg-zinc-800 pt-11 inline-block w-[100%] py-24 bg-gradient-to-t to-white from-creamwhite ">
      <div className="lg:max-w-[1440px] m-auto px-[20px] ">
        <div className="flex flex-row">
          <div className="w-[50%]">
            <h2 className="text-[25px] font-rubik text-greycolor">Manufacturing Excellence</h2>
            <h3 className="text-[45px] font-abel my-2 text-greencolor/80">
              Crafting Excellence, One Product at a Time
            </h3>
            <p className="text-[18px] font-roboto text-textblak">
